...
import com.aimerin.tmall.service.ProductImageService;
...
public class ProductImageController {
    ...
    public List<ProductImage> list(@RequestParam("type") String type, @PathVariable("pid") int pid) {
        ...
        if (ProductImageService.type_single.equals(type)) {
            List<ProductImage> singles = imageService.listSingleProductImages(product);
            return singles;
        } else if (ProductImageService.type_detail.equals(type)) {
            List<ProductImage> details = imageService.listDetailProductImages(product);
            return details;
        } else {
    ...
    public Object add(@RequestParam("pid") int pid, @RequestParam("type") String type, MultipartFile image,
        ...
        imageService.add(bean);
        String folder = "img/";
        if (imageService.type_single.equals(bean.getType())) {
    ...
    public String delete(@PathVariable("id") int id, HttpServletRequest request) {
        ProductImage bean = imageService.get(id);
